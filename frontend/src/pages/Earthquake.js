  ...
  return (
    <>
      ...
      <div className="relative py-32 lg:py-36 bg-slate-100 image-full">
        <div className="rounded-lg w-1/3 shadow-xl image-full mx-auto">
          <figure>
            <img
              ...
              src="https://images.unsplash.com/photo-1621077742331-2df96a07cca7?q=80&w=2685&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Shoes"
            />
          </figure>
        </div>
        ...
        >
          Look through earthquake causes at AKAP
        </h1>
        <button
