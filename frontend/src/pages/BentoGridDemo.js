...
import {
  BentoGrid,
  BentoGridItem,
} from "../components/homepage/bento-grid.tsx";
import {
...
export function BentoGridDemo() {
  ...
  useEffect(() => {
    ...
    if (mode === "recent") {
      setDisplayItems(items.slice(0, 5)); // Display the most recent 6 items
    } else if (mode === "urgent") {
...
const Skeleton = ({ imageUrl }) => (
  <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-neutral-200 dark:from-neutral-900 dark:to-neutral-800 to-neutral-100">
    <img src={imageUrl} alt="Skeleton" className="w-full h-full object-cover" />
  </div>
);
